/**
 * Step 99: Performance Audit: Lighthouse + WebGL
 */
import { startGPULoop } from '../../utils/gpuLoop.js'
import { PRESETS } from '../../presets/parameters.js'

export default {
  title: 'Performance Audit: Lighthouse + WebGL',
  chapter: 9,

  math: `<div class="math-section"><h3>Performance Audit</h3>
...
Set gl.getError() checks during development to catch GL errors early.</p></div>`,
  ...
  code: `<div class="code-section"><h3>Step 99 Code</h3>
