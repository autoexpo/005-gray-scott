/**
 * Step 21: The 5-Point Laplacian Stencil in 2D
 */


export default {
  title: 'The 5-Point Laplacian Stencil in 2D',
  chapter: 3,
...
<pre style="border:none;background:none;text-align:center;line-height:1.8">
  ...
  code: `<div class="code-section"><h3>Step 21 Code</h3>
...
//   src/presets/parameters.js — Named parameter presets
  ...
  init(container, state) {
    ...
    div.innerHTML = '<pre style="border:none;background:none">Step 21: The 5-Point Laplacian Stencil in 2D</pre>'
