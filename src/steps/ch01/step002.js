/**
 * Step 2: The Gray-Scott Equations — full PDE system.
 */
export default {
  title: 'The Gray-Scott Equations',
  chapter: 1,
...
`,
  ...
  init(container) {
    ...
    div.style.cssText = 'padding:24px; font-family:SF Mono,monospace; font-size:10pt;'
    div.innerHTML = `
