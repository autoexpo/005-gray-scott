/**
 * Step 6: Combining reaction and diffusion — the full Gray-Scott model.
 * Shows a basic 2D GPU simulation running for the first time.
 */
import { startGPULoop } from '../../utils/gpuLoop.js'
import { PRESETS } from '../../presets/parameters.js'

export default {
  title: 'Reaction + Diffusion Combined',
  chapter: 1,
