 ...
 * Physical intuition, biological examples, why patterns form.
 */
export default {
...
`,
  ...
  init(container) {
    // Static visualization: ASCII art diagram of two-species system
    const div = document.createElement('div')
    div.style.cssText = 'padding:24px; font-family:SF Mono,monospace; font-size:10pt; line-height:1.7'
